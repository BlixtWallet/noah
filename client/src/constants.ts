...
export const getServerEndpoint = (): string => {
  switch (APP_VARIANT) {
    case "regtest":
      return "http://192.168.1.161:3000";
    case "signet":
...
export const REGTEST_CONFIG: WalletCreationOptions = {
  ...
  bitcoin: false,
  config: {
    bitcoind: PLATFORM === "android" ? "http://10.0.2.2:18443" : "http://192.168.1.161:18443",
    asp: PLATFORM === "android" ? "http://10.0.2.2:3535" : "http://192.168.1.161:3535",
