...
namespace margelo::nitro::noahtools {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/noahtools/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/noahtools/Variant_NullType_String$First;";
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/noahtools/Variant_NullType_String$Second;";
