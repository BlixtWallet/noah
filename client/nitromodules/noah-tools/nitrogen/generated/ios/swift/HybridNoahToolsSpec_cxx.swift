...
open class HybridNoahToolsSpec_cxx {
  ...
  @inline(__always)
  public final func hasGooglePlayServices() -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.hasGooglePlayServices()
      let __resultCpp = __result
      return bridge.create_Result_bool_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
  ...
  @inline(__always)
  public final func registerUnifiedPush(topic: std.string) -> bridge.Result_void_ {
    do {
      try self.__implementation.registerUnifiedPush(topic: String(topic))
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func unregisterUnifiedPush() -> bridge.Result_void_ {
    do {
      try self.__implementation.unregisterUnifiedPush()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func getUnifiedPushEndpoint() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
