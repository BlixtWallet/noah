...
Noah Wallet includes iOS home screen widgets that display wallet balance information. The widgets are available for all three app variants (regtest, signet, mainnet) and support both small and medium sizes.
...
### Shared Code
All widgets share common implementation in `client/ios/SharedWidget/NoahBalanceWidget.swift`:
